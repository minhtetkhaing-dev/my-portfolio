...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 px-4 relative overflow-hidden">
      ...
      <motion.div
        className="absolute w-96 h-96 bg-gradient-to-r from-blue-200/20 to-cyan-200/20 dark:from-blue-500/10 dark:to-cyan-500/10 rounded-full -left-48 -top-24 blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
          rotate: [0, 45, 0],
      ...
      />
      <motion.div
        className="absolute w-96 h-96 bg-gradient-to-r from-purple-200/20 to-pink-200/20 dark:from-purple-500/10 dark:to-pink-500/10 rounded-full -right-48 -bottom-24 blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
          rotate: [0, -45, 0],
